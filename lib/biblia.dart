...
//    }
//
//    Widget gridViewLivros(List<Texto> textos) {
//      return Padding(
...
//                return Material(
//                    child: InkWell(
//                        onTap: () => { _abrirVersiculos(context, textos, index)},
//                        child: Container(
...
//  }
//
//  _abrirVersiculos(BuildContext context, List<Texto> textos, int index) {
//    Navigator.of(context).push(MaterialPageRoute(builder: (context) {
//      return LeitorBibliaStatefulWidget(textos, index);
//    }));
//  }
//}
